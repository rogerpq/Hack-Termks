...
keyboard = [
  ...
  [
    Button.url("المطور", "https://t.me/qlv88")
    ]
]
...
async def op(event):
  ...
  if not event.is_private:
    ...
    legendbye = [
      [
        Button.url("دوس هنا", f"https://t.me/qlv88")
        ]
      ]
...
async def start(event):
    keyboard = [
      ...
      [
        Button.url("المالك", "https://t.me/qlv88")
        ]
    ]
...
print(" لقد تم تنصيب البوت بنجاح.     للمساعده راسل المعرف التالي. @qlv88")
